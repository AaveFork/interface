...
export const MigrateV3ModalContent = ({
  ...
  const handleRoute = (market: CustomMarket) => {
    if (market === CustomMarket.proto_blast_sepolia_v3) {
      setCurrentMarket('proto_blast_sepolia_v3' as CustomMarket);
      router.push(`/?marketName=${CustomMarket.proto_blast_sepolia_v3}`);
    }
  };
